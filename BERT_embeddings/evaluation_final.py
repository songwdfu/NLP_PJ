...
def eval(model, args):
      ...
      test_dataset = FNCDataset(args.test_path, output_type="ext")
...
if __name__ == '__main__':
      ...
      parser.add_argument('--test_path', type=str, default='/sbert_embeddings/fnc_comp_test_mean_ext.pkl')
      parser.add_argument('--checkpoint_dir', type=str, default='checkpoints_mpnet/bests/total_ext_best_.pth')
