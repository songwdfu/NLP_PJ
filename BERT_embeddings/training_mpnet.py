...
def train(model, args):
      ...
      weights = torch.tensor([0.02761073, 0.26292578, 0.13216358, 0.57729991]).to(device)
      ...
      for e in range(1, epochs+1):
            ...
            if no_improvement >= patience:
                  ...
                  print(rep)
                  torch.save(model.state_dict(), f'checkpoints_mpnet/model_ep{e}.pth')
                  break
...
if __name__ == '__main__':
      ...
      parser.add_argument('--train_path', type=str, default='/sbert_embeddings/total_train_mean.pkl')
      parser.add_argument('--val_path', type=str, default='/sbert_embeddings/total_val_mean.pkl')
      parser.add_argument('--save_intvl', type=int, default=50)
      ...
      pkl.dump(history, open(f'checkpoints_mpnet/history_ep{args.epochs}.pkl','wb'))
