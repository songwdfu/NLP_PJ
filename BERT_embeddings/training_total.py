...
def train(model, args):
      ...
      for e in range(1, epochs+1):
            ...
            if no_improvement >= patience:
                  ...
                  print(rep)
                  torch.save(model.state_dict(), f'checkpoints/total_model_ep{e}.pth')
                  break
...
if __name__ == '__main__':
      ...
      parser.add_argument('--train_path', type=str, default='/gpt_embeddings/total_train_mean.pkl')
      parser.add_argument('--val_path', type=str, default='/gpt_embeddings/total_val_mean.pkl')
      ...
      pkl.dump(history, open(f'checkpoints/total_history_ep{args.epochs}.pkl','wb'))
