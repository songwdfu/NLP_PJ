...
def train(model, args):
      ...
      for e in range(1, epochs+1):
            ...
            if no_improvement >= patience:
                  ...
                  print(rep)
                  torch.save(model.state_dict(), f'checkpoints_mpnet/total_model_complex_ep{e}.pth')
                  break
...
if __name__ == '__main__':
      ...
      pkl.dump(history, open(f'checkpoints_mpnet/total_history_complex_ep{args.epochs}.pkl','wb'))
