...
def train(model, args):
      ...
      for e in range(1, epochs+1):
            ...
            if no_improvement >= patience:
                  ...
                  print(rep)
                  torch.save(model.state_dict(), f'checkpoints_mpnet/total_model_complex_fnc_only_ep{e}.pth')
                  break
...
if __name__ == '__main__':
      ...
      parser.add_argument('--train_path', type=str, default='/sbert_embeddings/fnc_train_mean.pkl')
      parser.add_argument('--val_path', type=str, default='/sbert_embeddings/fnc_val_mean.pkl')
      ...
      pkl.dump(history, open(f'checkpoints_mpnet/total_history_complex_fnc_only_ep{args.epochs}.pkl','wb'))
